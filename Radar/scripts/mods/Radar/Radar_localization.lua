return {
    ...
    nearby_highlight_distance_text_off = {
        en = "Off",
        fr = "Désactivé",
        de = "Aus",
        it = "Disattivato",
    ...
    auspex_animated_sweep_tooltip = {
        en = "Only affects the Auspex radar style.",
        fr = "S’applique uniquement au style de radar Auspex.",
        de = "Wirkt sich nur auf den Radarstil „Auspex“ aus.",
        it = "Influisce solo sullo stile radar Auspex.",
        es = "Solo afecta al estilo de radar Auspex.",
        pl = "Wpływa tylko na styl radaru Auspex.",
        ["pt-br"] = "Afeta apenas o estilo de radar Auspex.",
        ["ru"] = "Влияет только на стиль радара «Auspex».",
        ja = "Auspex レーダースタイルにのみ適用されます。",
        ko = "Auspex 레이더 스타일에만 적용됩니다.",
        ["zh-cn"] = "仅影响 Auspex 雷达样式。",
        ["zh-tw"] = "僅影響 Auspex 雷達樣式。",
    },
    radar_outline = {
        en = "Radar outline",
        fr = "Contour du radar",
    ...
    item_vertical_arrow_threshold_tooltip = {
        ...
        ["zh-tw"] = "當物品位於此水平距離內且在你上方或下方時，顯示向上或向下箭頭。",
    },
    item_vertical_hide_threshold_tooltip = {
        en = "Hide items from the radar when the vertical height difference is greater than this value.",
        fr = "Masquer les objets du radar lorsque la différence de hauteur verticale dépasse cette valeur.",
        de = "Blendet Gegenstände auf dem Radar aus, wenn der vertikale Höhenunterschied größer als dieser Wert ist.",
        it = "Nasconde gli oggetti dal radar quando la differenza di altezza verticale è maggiore di questo valore.",
        es = "Oculta los objetos del radar cuando la diferencia de altura vertical es mayor que este valor.",
        pl = "Ukrywa przedmioty na radarze, gdy różnica wysokości w pionie jest większa niż ta wartość.",
        ["pt-br"] = "Oculta itens do radar quando a diferença de altura vertical for maior que este valor.",
        ["ru"] = "Скрывать предметы с радара, когда разница по высоте превышает это значение.",
        ja = "高さの差がこの値を超える場合、アイテムをレーダーから非表示にします。",
        ko = "수직 높이 차이가 이 값보다 크면 레이더에서 아이템을 숨깁니다.",
        ["zh-cn"] = "当垂直高度差大于该值时，在雷达上隐藏物品。",
