return {
    ...
    auspex_animated_sweep = {
        ...
        fr = "Animated radar sweep",
        de = "Animated radar sweep",
        it = "Animated radar sweep",
        es = "Animated radar sweep",
        pl = "Animated radar sweep",
        ["pt-br"] = "Animated radar sweep",
        ["ru"] = "Animated radar sweep",
        ja = "Animated radar sweep",
        ko = "Animated radar sweep",
        ["zh-cn"] = "Animated radar sweep",
        ["zh-tw"] = "Animated radar sweep",
    },
    auspex_animated_sweep_tooltip = {
        en = "Only affects the Auspex radar style.",
        fr = "Only affects the Auspex radar style.",
        de = "Only affects the Auspex radar style.",
        it = "Only affects the Auspex radar style.",
        es = "Only affects the Auspex radar style.",
        pl = "Only affects the Auspex radar style.",
        ["pt-br"] = "Only affects the Auspex radar style.",
        ["ru"] = "Only affects the Auspex radar style.",
        ja = "Only affects the Auspex radar style.",
        ko = "Only affects the Auspex radar style.",
        ["zh-cn"] = "Only affects the Auspex radar style.",
        ["zh-tw"] = "Only affects the Auspex radar style.",
    },
    radar_outline = {
        en = "Radar outline",
        fr = "Contour du radar",
