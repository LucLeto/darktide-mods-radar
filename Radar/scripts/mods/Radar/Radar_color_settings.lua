...
-- Map-geometry layer colours; anchored to their checkbox so the ARGB sliders (including each
-- band's opacity, the alpha channel) appear inside the Map Geometry settings group. One colour
-- per floor band relative to the player: the current floor reads brightest, floors above are
-- faintest and drawn on top, floors below sit dimmer beneath.
_add_radar_color("show_navmesh", "radar_navmesh", _color(80, 101, 133, 96), "radar_navmesh_color")
_add_radar_color("show_navmesh", "radar_navmesh_above", _color(34, 120, 145, 175), "radar_navmesh_above_color")
_add_radar_color("show_navmesh", "radar_navmesh_below", _color(60, 92, 104, 120), "radar_navmesh_below_color")
